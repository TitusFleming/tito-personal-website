...
export const ROUTES: readonly SiteRoute[] = [
  ...
  {
    path: "/blog/ai-fundamentals/everything-is-a-function",
    title: "Everything Is a Function",
    summary:
      "Part 1 of The Fundamentals of AI. How machines see: draw a digit and watch it become 784 numbers, then a live prediction from a real trained model.",
    priority: 0.8,
    changeFrequency: "monthly",
    agentUse:
      "An interactive explanation of image classification: pixels to numbers to a softmax function, with a live MNIST model.",
  },
  {
    path: "/blog/ai-fundamentals/how-machines-learn",
    title: "How Machines Learn",
    summary:
      "Part 2 of The Fundamentals of AI. Gradient descent as a 3D game: a ball rolls downhill on a loss landscape, gets stuck in a local minimum, and you shake it out.",
    priority: 0.8,
    changeFrequency: "monthly",
    agentUse:
      "An interactive explanation of gradient descent, local minima, momentum, and simulated annealing.",
  },
  {
    path: "/blog/ai-fundamentals/everything-is-a-prediction",
    title: "Everything Is a Prediction",
    summary:
      "Part 3 of The Fundamentals of AI. A phone autocomplete built by counting one book, with a memory slider that shows why scale forces counting to become a function.",
    priority: 0.8,
    changeFrequency: "monthly",
    agentUse:
      "An interactive explanation of language models: next-word probability, temperature, context length, and generalization.",
  },
