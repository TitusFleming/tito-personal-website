...
export const OFFLINE_PROJECTS = [
  // Fleming Dash ships from the integration branch once the game is finished;
  // until then it is listed but not routable, so the sitemap and llms.txt
  // never point agents at a 404.
  {
    title: "Fleming Dash",
    summary:
      "A Geometry Dash-style platformer built from scratch: fixed-timestep physics, cube and ship modes, and levels imported from the original game data. In progress.",
  },
  {
